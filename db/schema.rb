...
ActiveRecord::Schema.define(version: 2021_02_14_042458) do
  ...
  create_table "discussion_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "campaign_id"], name: "index_discussion_topics_on_user_id_and_campaign_id", unique: true
  end
